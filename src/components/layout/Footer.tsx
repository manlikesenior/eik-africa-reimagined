        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/experiences" className="text-background/80 hover:text-primary transition-colors text-sm">
                  Safari Experiences
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/booking" className="text-background/80 hover:text-primary transition-colors text-sm">
                  Book Now
                </Link>
              </li>
            </ul>
