...
const countryData: CountryData[] = [
  {
    ...
    slug: "kenya",
    categories: [
      { label: "Safaris and Tours", href: "/experiences?country=Kenya&category=Wildlife Safari" },
      { label: "Discover Kenya", href: "/experiences?country=Kenya" },
      { label: "National Parks", href: "/experiences?country=Kenya&category=Wildlife Safari" },
      { label: "Beach Holidays", href: "/experiences?country=Kenya&category=Beach & Coastal" },
      { label: "Cultural Tours", href: "/experiences?country=Kenya&category=Cultural & Heritage" },
